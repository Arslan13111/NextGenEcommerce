...
object CardTierUtil {
    ...
    enum class CardTier(
        ...
        SILVER("Silver", 5.0, 0.0, "PKR 0"),
        GOLD("Gold", 8.0, 25_000.0, "PKR 25,000"),
        PLATINUM("Platinum", 12.0, 75_000.0, "PKR 75,000")
    }
    ...
    fun formatAmount(amount: Double): String {
        ...
        return if (intPart >= 1000) {
            ...
            if (remainder == 0L) "PKR $thousands,000" else "PKR $intPart"
        } else {
            "PKR $intPart"
        }
    }
